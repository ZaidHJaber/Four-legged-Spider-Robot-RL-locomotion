...
z_min = 0.001;       %0.03                    % min height of body from ground 0.2
y_max = 0.15;    %0.25                % max translation in y
vx_max = 0.25;                         % max horizontal speed of body >>>>>>>>..this was 0.25 before 1 Nov
vy_max = 0.25;                         % max lateral speed of body>>>>>>>>..this was 0.25 before 1 Nov
vz_max = 0.25;                         % max vertical speed of body>>>>>>>>..this was 0.25 before 1 Nov
...
%angles limits, 
min_tibiaRL_ang=-60 * d2r; %-33% SV1,SV2 and SV3 joint angle limit
max_tibiaRL_ang= 0 * d2r; %33 29Oct                                                                 <<<<<<<<<<<<<<<<<<<<<<<<

min_femurRL_ang= 0*d2r; %-27
max_femurRL_ang = 60*d2r; %45 29Oct                                                                 <<<<<<<<<<<<<<<<<<<<<<<<
